...
function Navbar() {
  ...
  return (
    <nav className="navbar navbar-expand-lg border-radius-lg top-0 z-index-3 shadow-none fixed-top  start-0 end-0  navbar-primary" style={{ backgroundColor: '#690505' }}> 
